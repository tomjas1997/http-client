...
use Invertus\Http\Client\Events\ConnectionFailed;
...
class PendingRequest
{
    ...
    {
        if ($dispatcher = $this->factory ? $this->factory->getDispatcher() : null) {
    ...
    {
        if (! ($dispatcher = $this->factory ? $this->factory->getDispatcher() : null) || ! $this->request) {
            return;
        }
