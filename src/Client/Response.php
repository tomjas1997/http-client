...
use Invertus\Http\Extractable\Helper;
use LogicException;
...
class Response implements ArrayAccess
{
    ...
    {
        return $this->transferStats ? $this->transferStats->getEffectiveUri() : null;
    }
    ...
    {
        return $this->transferStats ? $this->transferStats->getHandlerStats() : [];
    }
     ...
     *
     * @return \Invertus\Http\Client\RequestException|null
     */
     ...
     * @return $this
     *
     * @throws \Invertus\Http\Client\RequestException
     */
    ...
    {
        return Helper::value($condition, $this) ? $this->throw(func_get_args()[1] ?? null) : $this;
    }
